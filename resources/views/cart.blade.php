...
@section('content')
    <div class="flex flex-col mx-32 my-8">
        ...
        @if ($orders->count() == 0)
            <h1 class="text-5xl text-center font-bold">You haven't order anything yet. Go buy some!</h1>
        @else
            ...
            <a href="{{ route('user.checkout') }}"
                class="mt-7 w-1/3 bg-[#067A46] text-white text-base font-bold py-3 text-center rounded-sm hover:bg-[#157248] transition-colors duration-300 ease-in-out">Buy</a>
        @endif
    </div>
@endsection
