    ...
    <div class="flex flex-col my-14 mx-16">
        <div>
            ...
            <div class="absolute right-36 top-64">
                <h1 class="font-bold text-6xl text-white">Lebih Praktis <br></h1>
                <h1 class="font-bold text-6xl text-white mt-6">dan Ekonomis!</h1>
            </div>
        </div>
            ...
            @foreach ($items as $item)
                <div class="flex flex-col space-y-[10px] justify-center items-center">
                    ...
                    <a href="{{ route('user.item-detail', $item->item_id) }}"
                        class="bg-[#FFCF70] py-[2px] px-2 font-bold text-xs hover:bg-[#df9b14] transition-colors duration-300 ease-in-out rounded-sm">More
                        Detail</a>
                </div>
            @endforeach
        </div>
